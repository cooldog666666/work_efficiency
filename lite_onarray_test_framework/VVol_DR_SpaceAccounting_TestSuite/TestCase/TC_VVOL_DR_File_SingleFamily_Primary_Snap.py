...
testcase_name = 'TC_VVOL_DR_File_SingleFamily_Primary_Snap'
...
def TC_VVOL_DR_File_SingleFamily_Primary_Snap(storage, io_host, uemcli_host, windows_host, d_testparam, d_storage_object={}):
