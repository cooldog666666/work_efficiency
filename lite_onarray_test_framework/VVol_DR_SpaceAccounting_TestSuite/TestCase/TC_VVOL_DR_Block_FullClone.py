...
testcase_name = 'TC_VVOL_DR_Block_FullClone'
...
def TC_VVOL_DR_Block_FullClone(storage, io_host, uemcli_host, windows_host, d_testparam, d_storage_object={}):
    ...
    # updated_file_path = './io_config_file/new_vvol_write_50comp_0dedup_read_no_offset_0-10g.vdb'
