...
testcase_name = 'TC_VVOL_DR_Block_MultipleFamily'
...
def TC_VVOL_DR_Block_MultipleFamily(storage, io_host, uemcli_host, windows_host, d_testparam, d_storage_object={}):
    ...
    d_compare_profile['nAUsNeededIfNoCompression'] = compare_profile(values_to_compare=[0], symbols=['='], deviation=0.2)
